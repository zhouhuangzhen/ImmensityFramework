<template>
  <div class="app-container">
    ...
    <el-dialog title="停站时间过长详情" :visible.sync="open" width="1000px" height="500px">
      <el-table
        :ref="init.table.key"
        :key="init.table.key"
    ...
    return {
      ...
      init: {
        ...
        table: {
          ...
          key: 'table',
          emptytext: '暂无数据',
          datatype: 'QueryDailyStopPosotionSummary',
          datadetailtype: 'QueryDailyStopPosotionDetail',
      ...
      communicate
        ...
        .then(response => {
          if (response[vm.init.table.listnode]) {
            ...
            excelhelper.export('停站时间过长统计', headers, columns, data)
          } else {
            vm.msgError('无数据')
          }
          vm.unloading(myload)
