  ...
  <div class="app-container">
    ...
    <div class="area">
      ...
      >
        ...
        <el-table-column v-if="listQuery.SortMethod !='CompName'" prop="TheoreticalNum" width="180" label="理论数量" :resizable="true" align="center" />
    ...
    <el-dialog title="到离站详情" :visible.sync="open" width="1000px" height="500px">
      <el-table
        :ref="init.table.key"
        :key="init.table.key"
    ...
    return {
      ...
      init: {
        ...
        table: {
          ...
          key: 'table',
          emptytext: '暂无数据',
          datatype: 'QueryDailyPositionSummary',
          datadetailtype: 'QueryDailyPositionDetail',
      ...
      communicate
        ...
        .then(response => {
          if (response[vm.init.table.listnode]) {
            ...
            excelhelper.export('到离站信息统计', headers, columns, data)
          } else {
            vm.msgError('无数据')
          }
          vm.unloading(myload)
