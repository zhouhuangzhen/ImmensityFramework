    ...
    <div class="area">
      ...
      >
        ...
        <el-table-column
          ...
          align="center"
        />
        <el-table-column prop="AdjustReason" width="180" label="报警类型" :resizable="true" align="center" />
    ...
    return {
      ...
      init: {
        table: {
          ...
          key: 'table',
          emptytext: '暂无数据',
          datatype: 'QueryDailyAlarmSummary',
          datatypechart: 'QueryDailyAlarmChart',
      ...
      communicate
        ...
        .then(response => {
          if (response[vm.init.table.listnode]) {
            ...
            excelhelper.export('报警统计', headers, columns, data)
          } else {
            vm.msgError('无数据')
          }
          vm.unloading(myload)
