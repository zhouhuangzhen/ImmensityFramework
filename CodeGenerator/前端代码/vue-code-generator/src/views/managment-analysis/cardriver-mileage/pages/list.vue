<template>
  <div class="app-container">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="公司">
              <el-select v-model="query.StatComp" style="width:210px;">
          ...
          <el-col :span="8">
            <el-form-item label="部门">
              <el-select v-model="query.StatDept" style="width:210px;">
                <el-option key="all" label="全部" value />
              </el-select>
            </el-form-item>
          </el-col>
    ...
    <div class="area">
      ...
      >
        <el-table-column :label="$t('detail.index')" align="center" width="80" fixed="left">
        ...
        <el-table-column width="180" label="线路" property="xl" align="center" />
        <el-table-column width="180" label="里程" property="lc" align="center" />
        <el-table-column width="180" label="油耗" property="yh" align="center" />
        <el-table-column width="180" label="单耗" property="dh" align="center" />
        <el-table-column width="180" label="节费" property="jf" align="center" />
        <el-table-column width="180" label="投币营收" property="tbys" align="center" />
        <el-table-column width="180" label="IC营收" property="icys" align="center" />
        <el-table-column width="180" label="总营收" property="zys" align="center" />
      </el-table>
    ...
    <div class="area">
      ...
      >
        ...
        <el-table-column width="180" label="车型" property="cx" align="center" />
        <el-table-column width="180" label="里程" property="lc" align="center" />
        <el-table-column width="180" label="油耗" property="yh" align="center" />
        <el-table-column width="180" label="单耗" property="dh" align="center" />
        <el-table-column width="180" label="节费" property="jf" align="center" />
    ...
    <div class="area">
      <el-table
        ...
        style="width:100%;"
        :fit="true"
        :height="init.table3.height"
        :stripe="true"
        :empty-text="init.table3.emptytext"
      >
        <el-table-column type="index" label="序号" align="center" width="80" />
        <el-table-column width="180" label="车型" property="cx" align="center" />
        <el-table-column width="180" label="里程" property="lc" align="center" />
    ...
    return {
      ...
      init: {
        ...
        table: {
          ...
          key: 'table',
          emptytext: '暂无数据',
          datatype: 'OABusMileageList',
          listnode: 'OABusMileage'
        },
        table2: {
          height: window.innerHeight - 250,
          key: 'table2',
    ...
    getlist: function(pager) {
      ...
      communicate
        ...
        .then(response => {
          ...
          if (response[vm.init.table3.listnode]) {
            vm.data3 = vm.helpers.convert.object2array(response[vm.init.table3.listnode])
          }
      ...
      communicate
        ...
        .then(response => {
          if (response[vm.init.table.listnode]) {
            ...
            excelhelper.export('车辆行驶里程表--按车号', headers, columns, data)
          } else {
            vm.msgError('无数据')
          }
          if (response[vm.init.table2.listnode]) {
            ...
            excelhelper.export('车辆行驶里程表--按车型', headers, columns, data)
          }
          vm.unloading(myload)
        }).catch(error => {
          console.log(error)
