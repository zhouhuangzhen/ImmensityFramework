<template>
  <div class="app-container">
    <!--  查询条件  -->
    <el-row>
      <el-col :span="2" class="label">首末站 :</el-col>
      <el-col :span="6">
        <el-select v-model="query.station" :filterable="true" placeholder="请选择">
          <el-option
            v-for="item in init.search.station"
            :key="item.value"
            :label="item.label"
            :value="item.value"
          ></el-option>
      ...
      <el-col :span="2" class="label">线路 :</el-col>
      <el-col :span="6">
...
import Edit from "@/views/system-manage/infoscreen/pages/edit.vue";
