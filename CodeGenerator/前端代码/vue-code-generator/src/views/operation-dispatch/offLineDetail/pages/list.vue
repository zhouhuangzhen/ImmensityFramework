  ...
  <div class="app-container">
    ...
    <el-row>
      ...
      <el-col :span="4">
        <el-select v-model="listQuery.atttype" :placeholder="$t('ddllist.pleaseselect')">
          ...
          <el-option key="offline" :label="$t('ddllist.offline')" value="1" />
          <el-option key="online" :label="$t('ddllist.online')" value="2" />
        </el-select>
      </el-col>
    </el-row>
    <!--  按钮区域  -->
    ...
    <div class="area">
      <el-table
        ...
        @row-click="rowclick"
      >
        <el-table-column prop="name" width="180" label="指令" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="完成情况" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="轨迹回放" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="线路" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="班种" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="自编号" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="调整自编号" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="车牌号" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="调整车牌号" :resizable="true" align="center" />
        ...
        <el-table-column prop="name" width="180" label="调整驾驶员工号" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="调整驾驶员姓名" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="线路方向" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="计划时间" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="调整发车时间" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="实发时间" :resizable="true" align="center" />
        <el-table-column prop="name" width="180" label="首站时间" :resizable="true" align="center" />
      </el-table>
